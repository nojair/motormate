    ...
    <div class="flex flex-row justify-start items-center sm:mb-0 mb-5">
      ...
      <div class="flex flex-col justify-center items-center sm:mx-7">
        ...
        <span class="flex flex-row items-center">
          <p class="cursor-default w-fit px-4 text-center text-sky-100 font-black py-1">{{ userStore.location.administrative_area_level_2 }}, {{ userStore.location.administrative_area_level_1 }}</p>
